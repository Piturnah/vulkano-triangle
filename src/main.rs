...
use vulkano::swapchain::{acquire_next_image, AcquireError, Swapchain, SwapchainCreateInfo};
    ...
    event_loop.run(move |event, _, control_flow| {
        match event {
            ...
            Event::RedrawEventsCleared => {
                ...
                // Oh yeah, it's triangle time
                let clear_values = vec![[0.2, 0.3, 0.3, 1.0].into()];
